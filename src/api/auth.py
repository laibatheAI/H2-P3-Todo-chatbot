...
from src.services.auth import register_user, authenticate_user, create_auth_tokens, register_user_async, authenticate_user_async
...
async def register(
    ...
    try:
        ...
        from src.services.auth import register_user_async
        ...
        # Create auth tokens
        from src.services.auth import create_auth_tokens
...
async def login(
    ...
    """
    from src.services.auth import authenticate_user_async
...
def get_current_user(
    ...
    """
    from src.services.jwt_service import get_user_id_from_token
    ...
    # Use select query instead of session.get to avoid UUID conversion issues
